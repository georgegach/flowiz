...
parser.add_argument('--min_rad', '-m', action='store', type=float, default=0, help='Minimum radial vector length for normalization of flow')
...
fz.convert_files(flos, outdir=args.outdir, min_rad=args.min_rad)
