...
def generate_index_html(savedir, accessdir, indexpath):
    files = glob(os.path.join(savedir, "*.png"))
    generated = ""
    # generated += folder.format(href="/", title="/", size="", date="")
    for f in files:
    ...
    with open(indexpath, "w") as i:
        i.write(head + generated + tail)
...
#             <li><a href="/flowiz/gui/web" class="icon icon-directory" title=".."><span class="name">..</span><span
#                         class="size"></span><span class="date"></span></a></li> 
#             
#             <li><a href="/flowiz/gui/web/guitemp/frame_0001.flo.png" class="icon icon icon-png icon-image"
#                     title="frame_0001.flo.png"><span class="name">frame_0001.flo.png</span><span
#                         class="size">103712</span><span class="date">7/20/2019 4:55:33 PM</span></a></li>


folder = """"
            <li><a href="{href}" class="icon icon-directory" title="{title}"><span class="name">{title}</span><span
                        class="size">{size}</span><span class="date">{date}</span></a></li> 
"""

file = """
            <li><a href="{href}" target="_blank" class="icon icon icon-png icon-image"
                    title="{title}"><span class="name">{title}</span><span
                        class="size">{size}</span><span class="date">{date}</span></a></li>
"""
...
tail = """
        ...
        <div class="logo" style="width:100%; text-align: center; margin-top:50px; opacity: 1;">
            ...
            <br /><br />
            <img src="../assets/ubuntu283.png" width="200px" class="" alt="">
        </div>
    </div>
</body>
